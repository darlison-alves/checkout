...
export const Header = () => {
  ...
  return (
    <div className="relative bg-white">
      ...
      <div style={{ display: showMenu ? 'block' : 'none' }} className="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
            ...
            <div className="mt-6" >
              <nav className="grid gap-y-8">
                <a href="#" className="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                  ...
                  <Link to={'/companies'} className="ml-3 text-base font-medium text-gray-500 hover:text-gray-900"> Empresas </Link>
                </a>
                ...
                <a href="#" className="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                  ...
                  <Link to={'/my-coupons'} className="ml-3 text-base font-medium text-gray-500 hover:text-gray-900"> Meus Cupons </Link>
                ...
                <a href="#" className="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                  ...
                  <Link to={'/extracts'} className="ml-3 text-base font-medium text-gray-500 hover:text-gray-900"> Extratos </Link>
                ...
                <a href="#" className="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                  ...
                  <Link to={'/indications'} className="ml-3 text-base font-medium text-gray-500 hover:text-gray-900"> Indicados </Link>
                ...
                <a href="#" className="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                  ...
                  <Link to={'/indications'} className="ml-3 text-base font-medium text-gray-500 hover:text-gray-900"> Compartilhar link </Link>
                ...
                <a href="#" className="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                  ...
                  <Link to={'/indications'} className="ml-3 text-base font-medium text-gray-500 hover:text-gray-900"> Documentos </Link>
                </a>
