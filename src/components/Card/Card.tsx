...
export const CardPlan = ({ name, price = 0, color="", darkBgColor = "", style = {}, onClick = () => {}}: IPlan) => {
  return (
    <div style={style} className={`p-4 max-w-sm bg-${color} rounded-lg border shadow-md sm:p-8 dark:${darkBgColor} dark:border-gray-700 ml-2`}>
