...
export const SuccessSendToast = ({ message }: ISuccessSendToastProps) => {
  return (
    <div id="toast-success" className="flex absolute right-2 items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
